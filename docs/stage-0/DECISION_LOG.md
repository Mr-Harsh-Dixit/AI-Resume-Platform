...
| DEC-S0-006 | Controlled source storage | Product owner + lead developer | **Accepted; review pending** | Store the two authoritative originals in private repository `Mr-Harsh-Dixit/AI-Resume-Platform-Sources`; public records use immutable commit-pinned URLs and checksums. The source files remain excluded from the public implementation repository. | S0-02 |
