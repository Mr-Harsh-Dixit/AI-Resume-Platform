...
| DEC-S0-003 | Named review authorities | Product owner | **Partially accepted** | A non-builder Codex review instance evaluated S0-03 at commit `8f90f2a474bad9f95e47f33655f3847fc0e7694d`: product/domain PASS, technical FAIL. The implementing Codex remains accountable for remediation and cannot issue the fresh PASS. Product-owner approval and named qualified reviewers for later occupation-profile gates remain required. | Stage entry, S0-03, S0-06, S0-07, S0-EXIT-04, S0-EXIT-08 |
