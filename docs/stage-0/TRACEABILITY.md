...
| S0-02 | Freeze the baseline | Immutable source manifest, checksum, storage URI, change policy | `in_progress` | Storage/repository choice, independent review, GitHub checkpoint |
